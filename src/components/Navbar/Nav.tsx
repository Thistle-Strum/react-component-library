  ...
  return (
    <nav className="py-10 px-10 bg-[#181B38]">
      <div className="flex flex-col lg:flex-row">
        ...
        <div onClick={()=> setIsOpened(!isOpened)}  className={`ease-linear duration-500 py-5 px-0 text-start lg:flex lg:space-x-12 lg:flex-row lg:items-end lg:static lg:m-auto lg:w-auto lg:p-0 ${isOpened? 'flex flex-col mt-12' : '-top-48 hidden' }`}>
